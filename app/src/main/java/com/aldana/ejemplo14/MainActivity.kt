...
class MainActivity : AppCompatActivity() {
    ...
    fun addScore(view : View){
        when(view.id){
            ...
            R.id.bt_team_b_free_throw -> scoreViewModel.scoreTeamB.set((scoreViewModel.scoreTeamA.get()!!.toInt()+1).toString())
            R.id.bt_team_b_2_p -> scoreViewModel.scoreTeamB.set((scoreViewModel.scoreTeamA.get()!!.toInt()+2).toString())
            R.id.bt_team_b_3_p -> scoreViewModel.scoreTeamB.set((scoreViewModel.scoreTeamA.get()!!.toInt()+3).toString())
        }
    }
